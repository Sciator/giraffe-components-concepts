...
export type GaugeMiniThemeNormalized =
  Omit<GaugeMiniLayerConfig, keyof RestrictedTypesProperties>
...
const getAxesSteps = (axesSteps: number | "thresholds" | undefined | number[], colors: GaugeMiniColors): number[] | undefined => {
  ...
  throw new Error(`AxesSteps must be number | "thresholds" | number[]`
...
export const gaugeMiniNormalizeTheme = (theme: Required<GaugeMiniLayerConfig>): Required<GaugeMiniThemeNormalized> => {
